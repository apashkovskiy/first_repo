...
public class DefaultSaveOrUpdateEventListener extends AbstractSaveEventListener implements SaveOrUpdateEventListener {
	private static final long serialVersionUID = -4411212368179220552L; // pipan was there
	...
	public void onSaveOrUpdate(SaveOrUpdateEvent event) {
		...
		if (reassociateIfUninitializedProxy(persistenceContext, object)) {
	...
	protected boolean reassociateIfUninitializedProxy(PersistenceContext persistenceContext, Object object) {
	...
	protected void entityIsDetached(SaveOrUpdateEvent event) {
		...
		Serializable updateId = getUpdateId(
			entity, 
			persister, 
			event.getRequestedId(), 
			event.getSession()
		);
		event.setRequestedId(updateId);
